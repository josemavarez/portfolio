...
if ($name == "") {
    ...
    $headers .= 'From:  Papr <joseemava@gmail.com>' . "\r\n";
    $headers .= 'cc: joseemava@gmail.com' . "\r\n";
    $headers .= 'bcc: joseemava@gmail.com' . "\r\n";
    mail($to, $subject, $_message, $headers, '-f joseemava@gmail.com');
